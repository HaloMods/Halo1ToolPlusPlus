...
namespace Tool__
{
	public class Animations : Wrapper
	{
		...
		private void InitializeComponent()
		{
			...
			this.Controls.SetChildIndex(this.SourceDirectory, 0);
		...
		private void OnRun(object sender, System.EventArgs e)
		{
			...
			else
			{
				...
				processCaller.Arguments = string.Format("animations {0}", this.SourceDirectory.Field);
				processCaller.Start();
			}
		}
	}
