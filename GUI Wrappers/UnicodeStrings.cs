...
namespace Tool__
{
	public class UnicodeStrings : Wrapper
	{
		private System.Windows.Forms.Button Run;
		private Tool__.FolderReference SourceDirectory;

		public UnicodeStrings()
		{
		...
		private void InitializeComponent()
		{
			...
			this.SourceDirectory.TabIndex = 4;
			// 
			// UnicodeStrings
			// 
			this.Controls.Add(this.Run);
			this.Controls.Add(this.SourceDirectory);
			this.Name = "UnicodeStrings";
		...
		private void OnRun(object sender, System.EventArgs e)
		{
			...
			else
			{
				...
				processCaller.Arguments = string.Format("unicode-strings {0}", this.SourceDirectory.Field);
				processCaller.Start();
			}
		}
	}
